...
Download and install `.NET SDK 8.0` from Microsoft.
...
On Windows, enabling WSL 2 may be required.
Restart the computer after installation.
Start Docker Desktop and wait until the status is set to `Running`.
...
After registration, the user will be logged in automatically.
