...
The output should include `gym\_sql` with the `Up` status.
...
docker exec -it gym\_sql /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "Change\_This\_Password\_123!" -C -Q "UPDATE GymManagerDb.dbo.Users SET Role = 'admin' WHERE Email = 'your@email.com';"
